...
def Message processData(Message message) {
    ...
    message.setBody(body + " REMOTE Body is modified BASE CS2");
    ...
    message.setProperty("REMOTEnewProperty", "newProperty"); 

message.setProperty("NEW LINES  IN  REMOTE", "newProperty"); 
